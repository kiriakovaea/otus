...
class TestProductCartPage:
    ...
    @allure.story('Find elements')
    def test_find_elements_product_cart_page(self, browser):
    ...
    @allure.feature('Product Cart Page')
    @allure.story('Check review rating error')
    def test_product_cart_page_(self, browser):
        product_cart_page = ProductCartPage(browser)
